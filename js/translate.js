...
let wst = {
  ...
  about: {
    ...
    j: [
      '私',
      'アメリカから、日本の東京でソフトエアの開発者とビジュアルアーティストです。プログラミングとクリエテイブデザインは１番強みです。それら実力は絶えず磨っています。嬉しくプロジェクトはUIインタフェースを作ったりとアニメシャンをプログラんしたりデジタルコンテンツを編集したり。働いていないとき友達と遊んだりと音楽を作ったりと東京じゅう探索したります。'
    ]
  },
